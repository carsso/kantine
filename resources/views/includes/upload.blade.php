    ...
    <div class="bg-white dark:bg-gray-700 rounded-lg shadow-sm p-4 text-center mt-6">
        <form action="{{ route('upload') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mt-2">
                ...
                <input type="file" name="files[]" multiple id="file-input" class="block w-full border border-gray-200 shadow-xs rounded-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-500 dark:text-gray-400
