...
<div class="bg-white dark:bg-gray-700 rounded-lg shadow px-4 py-5 text-center mt-6 border-t-4 {{ $menu->is_fries_day || $menu->is_burgers_day ? 'border-red-500' : ($menu->event_name ? 'border-green-500' : 'border-blue-500') }}">
